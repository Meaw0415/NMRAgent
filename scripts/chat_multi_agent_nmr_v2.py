#!/usr/bin/env python3
"""Interactive terminal chat wrapper for MultiAgentNMRV2."""
...
def _build_agent(args: argparse.Namespace):
    ...
    return MultiAgentNMRV2.from_config(config, **overrides)
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Interactive chat wrapper for MultiAgentNMRV2.")
